...
public abstract class BaseGrpcBrandService : BrandProtoService.BrandProtoServiceBase, IBaseGrpcService
{
    private IHttpContextAccessor _httpContextAccessor;
    
    protected BaseGrpcBrandService(IHttpContextAccessor httpContextAccessor)
    {
