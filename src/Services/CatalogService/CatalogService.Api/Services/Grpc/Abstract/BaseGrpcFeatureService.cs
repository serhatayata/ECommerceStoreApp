...
public abstract class BaseGrpcFeatureService : FeatureProtoService.FeatureProtoServiceBase, IBaseGrpcService
{
    private IHttpContextAccessor _httpContextAccessor;

    protected BaseGrpcFeatureService(IHttpContextAccessor httpContextAccessor)
    {
