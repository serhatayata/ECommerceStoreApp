...
public class BrandService : BaseService, IBrandService
{
    ...
    public async Task<Result> AddAsync(BrandAddModel model)
    {
        ...
        if (nameExists.Success)
            return new ErrorResult(this.GetLocalizedValue("branservice.add.name.alreadyexists"));
    ...
    public async Task<Result> UpdateAsync(BrandUpdateModel model)
    {
        ...
        if (nameExists.Success)
            return new ErrorResult(this.GetLocalizedValue("branservice.update.name.alreadyexists"));
