...
public class DapperCategoryRepository : BaseRepository, IDapperCategoryRepository
{
    ...
    public async Task<Result> AddAsync(Category entity)
    {
        ...
        try
        {
            ...
            if (categoryId == 0)
                return new ErrorResult(this.GetLocalizedValue("dapper.categoryrepository.add.notadded"));

            transaction.Commit();
            return new SuccessResult(this.GetLocalizedValue("dapper.categoryrepository.add.added"));
        }
        catch (Exception ex)
        {
    ...
    public async Task<Result> DeleteAsync(IntModel model)
    {
        ...
        try
        {
            ...
            return result > 0 ? 
                new SuccessResult(this.GetLocalizedValue("dapper.categoryrepository.delete.deleted")) : 
                new ErrorResult(this.GetLocalizedValue("dapper.categoryrepository.delete.notdeleted"));
        }
        catch (Exception ex)
        {
            transaction.Rollback();
    ...
    public async Task<Result> UpdateAsync(Category entity)
    {
        ...
        try
        {
            ...
            return result > 0 ? 
                new SuccessResult(this.GetLocalizedValue("dapper.categoryrepository.update.updated")) : 
                new ErrorResult(this.GetLocalizedValue("dapper.categoryrepository.update.notupdated"));
        }
        catch (Exception ex)
        {
            transaction.Rollback();
