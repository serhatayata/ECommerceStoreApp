...
namespace CampaignService.Api.DependencyResolvers.Autofac
{
    public class AutofacBusinessModule : Module
    {
        ...
        {
            builder.RegisterType<CampaignSchema>().InstancePerDependency();
            builder.RegisterType<CampaignItemSchema>().InstancePerDependency();
            builder.RegisterType<CampaignSourceSchema>().InstancePerDependency();
            builder.RegisterType<CampaignRuleSchema>().InstancePerDependency();
